    ...
    <footer>
      <div className="logo-containers">
        ...
        <span className="social-links">
          <a href="#">
            <img className="social-icon" src="images/icon-facebook.svg" alt="Facebook Icon" />
          </a>
          <a href="#">
            <img className="social-icon" src="images/icon-youtube.svg" alt="Youtube Icon" />
          </a>
          <a href="#">
            <img className="social-icon" src="images/icon-twitter.svg" alt="Twitter Icon" />
          </a>
          <a href="#">
            <img className="social-icon" src="images/icon-pinterest.svg" alt="Pinterest Icon" />
          </a>
          <a href="#">
            <img className="social-icon" src="images/icon-instagram.svg" alt="Instagram Icon" />
          </a>
        </span>
      </div>
